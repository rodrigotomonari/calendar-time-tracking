class ProjectsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @project.save
        format.html { redirect_to edit_project_path(@project), notice: t('flash_messages.projects.created') }
  ...
  def update
    respond_to do |format|
      if @project.update(project_params)
        format.html { redirect_to edit_project_path(@project), notice: t('flash_messages.projects.updated') }
  ...
  def destroy
    @project.destroy
    respond_to do |format|
      format.html { redirect_to projects_url, notice: t('flash_messages.projects.destroyed') }
